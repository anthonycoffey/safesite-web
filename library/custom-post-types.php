...
function Features() {
	...
	$args = array(
		...
		'description'           => __( 'Safesite Features', 'text_domain' ),
		'labels'                => $labels,
...
function industry() {
	...
	$labels = array(
		...
		'archives'              => __( 'Industry Archives', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Industry Posts', 'text_domain' ),
		'labels'                => $labels,
...
function company_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Company Posts', 'Post Type General Name', 'text_domain' ),
		...
		'attributes'            => __( 'Company Post Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'Company Items', 'text_domain' ),
		'add_new_item'          => __( 'Add New Company Item', 'text_domain' ),
		'add_new'               => __( 'Add New', 'text_domain' ),
		'new_item'              => __( 'New Item', 'text_domain' ),
		'edit_item'             => __( 'Edit Item', 'text_domain' ),
		'update_item'           => __( 'Update Item', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Company posts', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,

...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	function foundationpress_scripts() {
		...
		wp_enqueue_script( 'masonry-js', get_template_directory_uri() . '/dist/assets/js/' . foundationpress_asset_path( 'masonry.js' ), array( 'jquery' ), '2.10.4', false );

		// Enqueue masonry scripts
		wp_enqueue_script( 'custom-maps', get_template_directory_uri() . '/dist/assets/js/' . foundationpress_asset_path( 'map.js' ), array( 'jquery' ), false );
